...
find /scratch/cloutcha/runs/{baseline_local,dqn_local,ppo_local,sac_local}/pear/seed_1/wandb/ -type d \( -name "run-20260316*" -o -name "offline-run-20260316*" -o -name "run-20260317*" -o -name "offline-run-20260317*" \) 2>/dev/null | while read -r run_dir; do
    echo "---------------------------------------------------"
